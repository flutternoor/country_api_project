import 'dart:async';
import 'dart:convert';
import 'package:country_api_project/screens/country_detail_screen.dart';
                    ...
                    child: Card(
                      color: Colors.brown,
                        child: ListTile(
                          ...
                          title: Text(myData.name.toString(),style: TextStyle(color: Colors.white,fontSize:18,fontWeight: FontWeight.w400),),
